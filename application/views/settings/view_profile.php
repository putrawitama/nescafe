 ...
 <!-- Main content -->
    ...
    <section class="content">
      ...
      <div class="row">
        <div class="col-md-12">
<?php foreach ($cetak1->result() as $bp){ ?>
            <?php $set = $bp->NIP ;?>
          <!-- Profile Image -->
         <div class="box box-primary">
            <div class="box-body box-profile">
              <img class="profile-user-img img-responsive img-circle" style=" width: 190px "  src="<?= base_url()?>asset/user/<?= $bp->FOTO_PEG?>" alt="User profile picture">
              ...
              <p class="profile-username text-center" >                     
               <?php
                ...
                <form class="form-horizontal" >
                 ...
                 <a class="btn btn-default" href="<?php echo site_url('Controller_access')?>">BACK</a>
               <a class="btn btn-success pull-right" href="<?php echo site_url('Settings/profile')?>">UPDATE PROFIL</a>
              </div>
