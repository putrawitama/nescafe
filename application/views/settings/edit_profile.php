...
<div class="col-md-12">
          ...
          <div class="box box-info">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <?php foreach ($cetak1->result() as $cetak){ ?>
            <?php $set = $cetak->NIP ;?>
            <form class="form-horizontal" action="<?= base_url('Settings/profile')?>" enctype="multipart/form-data" method="post">
              <div class="box-body">
               <div class="form-group">
                  <label for="inputEmail3" class="col-sm-2 control-label">NIP</label>
                  <div class="col-sm-8">
                    <input type="text" class="form-control" placeholder="NIP" value="<?=$cetak->NIP ?>" name="nip" readonly>
                  </div>
                </div>
                <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputPassword3" class="col-sm-2 control-label">Photo</label>
                    <div class="col-sm-8" >
                    <img src="<?= base_url()?>asset/user/<?= $cetak->FOTO_PEG ?>?rand=<?php echo rand(); ?>" height="142" width="142">
