    ...
    <section class="content-header">
      <h1>
       DETAIL PRODUCT REQUEST
        <small>detail Permintaan Barang</small>
      </h1>
      <ol class="breadcrumb">
...
<div class="row">
   ...
   <div class="col-md-2">
      <b>:<?php echo $deliv->KODE_PERMINTAAN; ?></b>
   </div>
   </div>
   <div class="row">
   <div class="col-md-2">
...
<div class="right">
   ...
   <a href="<?= base_url("Admin/cetak_req_pdf/$kode")?>" class="btn btn-primary pull-right">Download as PDF</a>
